# place_bouton_v02.py — Version 1.1
# v1.1 : lien YouTube s'ouvre dans un nouvel onglet/fenetre (NewWindow=True)
# v1.0 : creation
...
def placer_bouton(fichier_src, fichier_dst,
    ...
    # NewWindow=True : ouvre YouTube dans un nouvel onglet/fenetre
    from pypdf.generic import NameObject, BooleanObject
    annotation = Link(rect=rect_lien, url=youtube_url)
    annotation[NameObject("/A")][NameObject("/NewWindow")] = BooleanObject(True)
