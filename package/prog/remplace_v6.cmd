@echo off
REM remplace_v6.cmd — Version 6
REM partition_utils v2.2 : correction transparence fond (setFillAlpha)
chcp 65001 >nul
...
call :copier "%SRC%\partition_utils_v2.2.py"   "%LIB%\partition_utils.py"
...
echo.
echo ============================================================
echo  ACTION MANUELLE : supprimer le PDF final pour forcer regeneration
