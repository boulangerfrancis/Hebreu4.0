...
FICHIERS = [
    ...
    ("lancer_v4.1.cmd",            DST / "lancer.cmd",           True),
    ...
    # lib1\
    ("lib1_fichier_utils_v1.1.py",   LIB / "fichier_utils.py",     True),
    ("lib1_html_utils_v1.0.py",      LIB / "html_utils.py",        True),
    ("lib1_config_shim_v4.0.py",     LIB / "config.py",            False),
    ("lib1_options_shim_v2.0.py",    LIB / "options.py",           False),
    ("lib1_partition_utils_v2.3.py", LIB / "partition_utils.py",   True),
    ("lib1_pdf_utils_v1.1.py",       LIB / "pdf_utils.py",         True),
    ("lib1_structure_utils_v2.1.py", LIB / "structure_utils.py",   True),
]
